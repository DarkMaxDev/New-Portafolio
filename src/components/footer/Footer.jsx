                ...
                >
                    ...
                    >
                        <div className="footer-logo">
                            <img src={logo} alt="DarkMaxDev Logo" className="logo-image"/>
                            <span className="footer-logo-text">Gustavo Maximiliano</span>
                        </div>
                ...
                >
                    <div className="footer-bottom-content">
                        <p className="footer-copyright">
                            © {currentYear} Gustavo Maximiliano. {t('footer.rights')}
                        </p>
                        <SocialLinks/>
                    </div>
                </motion.div>
